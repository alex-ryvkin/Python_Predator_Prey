...
def particle_swarm_optimization(obj_func, bounds, num_particles, num_iterations, inertia_weight, cognitive_weight, social_weight):
    ...
    for _ in range(num_iterations):
        ...
        particle_fitness = obj_func(particle_positions[:, 0], particle_positions[:, 1],particle_positions[:, 2], particle_positions[:, 3])   #!!!!!
...
#==========================================================
def PrePre(alpha,beta,gamma,delta):
...
bounds = np.array([[0.05, 1], [0.001, 0.05],[0.05, 1], [0.001, 0.05]])
...
x_values = PrePre(best_position[0],best_position[1],best_position[2],best_position[3])
